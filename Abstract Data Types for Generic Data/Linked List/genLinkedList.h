...
bool gLinkedListHasSameElements(gLinkedList* list1, gLinkedList* list2);                                                                         // Check whether two linked lists contain the same elements regardless of the order in which they appear. Returns 1 if the lists share the same content and 0 otherwise;
...
size_t gLinkedListCount(gLinkedList* list, gLinkedListDataPtr data);                                                                             // Counts and returns the number of occurrences of a given element in the linked list;
